...
namespace lasd
{
    ...
    {
        while (!pushedChildren.Top())
        {
            pushedChildren.Pop();
            pushedChildren.Push(true);
    ...
    BTPostOrderIterator<Data>::BTPostOrderIterator(const BTPostOrderIterator &other)
    {
        root = other.root;
        nodes = other.nodes;
        pushedChildren = other.pushedChildren;
    }
    ...
    BTPostOrderIterator<Data>::BTPostOrderIterator(BTPostOrderIterator &&other) noexcept
    {
        std::swap(root, other.root);
        std::swap(nodes, other.nodes);
        std::swap(pushedChildren, other.pushedChildren);
    }
